...
Architecture Decision Records (ADRs) capture decisions that materially affect the platform's structure, delivery, security, or operating model.

- [ADR 0001 - Begin with a monorepo](docs/adr/0001-monorepo.md)
- [ADR 0002 - React and FastAPI application boundary](docs/adr/0002-react-fastapi.md)
